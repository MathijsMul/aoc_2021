...
if __name__ == "__main__":
    sample1_input = read_file("data/day_23/sample1.txt")
    sample2_input = read_file("data/day_23/sample2.txt")
    sample3_input = read_file("data/day_23/sample3.txt")
    real_input = read_file("data/day_23/input.txt")
